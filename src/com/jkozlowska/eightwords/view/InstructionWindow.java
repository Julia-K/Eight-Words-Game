...
public class InstructionWindow extends Scene {
    ...
    private Rectangle rectangle = new Rectangle(700,550);
    ...
    public InstructionWindow(BorderPane root) {
        ...
        rectangle.setStroke(Color.web(AllValues.COLOR3));
    ...
    private void showDescription() {
        ...
        Image img = new Image("com/jkozlowska/eightwords/files/boardJPG.jpg");
    ...
    private void showButtonsDescription() {
        Image img = new Image("com/jkozlowska/eightwords/files/OwnBoardJPG.jpg");
        ImageView imgView = new ImageView(img);
